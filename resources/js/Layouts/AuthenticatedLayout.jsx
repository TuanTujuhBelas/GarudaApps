...
const NAV_LINKS = {
    'Super Admin': [
        { href: 'admin.users.index',    label: 'Kelola Pengguna' },
        { href: 'admin.events.index',   label: 'Kelola Acara' },
        { href: 'admin.keuangan.index', label: 'Laporan Kas' },
    ],
    'Bendahara': [
        { href: 'bendahara.keuangan.index', label: 'Buku Kas' },
    ],
    'Pelatih': [
        { href: 'pelatih.keuangan.index',   label: 'Laporan Kas' },
        { href: 'pelatih.verifikasi.index', label: 'Verifikasi Berkas' },
    ],
    'Murid': [
        { href: 'murid.events.index', label: 'Acara Mendatang' },
    ],
};

...
import { User, Mail, Shield, ShieldCheck, Trash2, Edit2, Search, X, Check } from 'lucide-react';
...
export default function Index({ users, roles, rantings }) {
                    ...
                    <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="bg-red-500/10 px-4 py-2 rounded-xl border border-red-500/20 text-center">
                                ...
                                <p className="text-xl font-black text-red-500">{users.filter(u => u.is_aktif).length}</p>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <button 
                                                        ...
                                                        disabled={user.email === 'respati@garuda.com' || user.email === 'bagus@garuda.com'}
                                                    >
                                                        <Trash2 size={16} />
                                                    </button>
                                                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                disabled={editingUser?.email === 'respati@garuda.com' || editingUser?.email === 'bagus@garuda.com'}
                            >
                                {roles.map(r => (
                                    <option key={r.id} value={r.id} className="bg-black">{r.nama_role}</option>
                                ))}
                            </select>
                            {(editingUser?.email === 'respati@garuda.com' || editingUser?.email === 'bagus@garuda.com') && (
                                <p className="mt-1 text-xs text-red-500 italic">Role Super Admin utama tidak dapat diubah.</p>
                            )}
                        </div>
